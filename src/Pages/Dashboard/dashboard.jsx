    ...
    <div className="app__dash">
      <div className="app__dash-box1">
        <div className="app__dash-heading_box">
          <div className="app__dash-Heading">Welcome, Vaibhav<span>!</span></div>
          ...
          <div className="app__dash-boxes">
            <div className="app__dash-bp">
              <div className="app__dash-bp_img">
                ...
                <p>110 <span>/</span> 75 <span>mmHg</span></p>
          ...
          <div className="app__dash-allergy_box">
            You're  Healthy
          </div>
        </div>
        <div className="app__dash-profile_box">
          ...
          <div className="app__dash-Person_info_box">
            <div className="app__dash-Person_info">
              <MdBloodtype size={45}/>
              <p className="app__subhead" style={{fontWeight:"bold"}}>Blood</p>
              <h4>B-</h4>
            </div>
            <div className="app__dash-Person_info">
              <GiBodyHeight size={45}/>
              <p className="app__subhead" style={{fontWeight:"bold"}}>Height</p>
              <h4>174 <span>cm</span></h4>
            </div>
            <div className="app__dash-Person_info">
              <MdMonitorWeight size={45} />
              <p className="app__subhead" style={{fontWeight:"bold"}}>Weight</p>
